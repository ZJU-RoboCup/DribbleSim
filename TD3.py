# -*- coding: utf-8 -*-
"""
Created on Mon Feb 25 12:19:54 2019
@brief: vanilla
@author: Wang Yunkai
"""
...
class TD3(object):
    ...
    def train(self, replay_buffer, iterations, batch_size=100, discount=0.99, tau=0.005, policy_noise=0.2, noise_clip=0.5, policy_freq=2):
        ...
        for it in range(iterations):
            ...
            #print('next', self.actor_target(next_state))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env_name", default="Dribble-v0")			# OpenAI gym environment name
    ...
    parser.add_argument("--min_expl_noise", default=0.01, type=float)    # Std of Gaussian exploration noise
    ...
    while total_timesteps < args.max_timesteps:
        if done:
            ...
            if episode_num > 300 and episode_num % 50 == 0:
